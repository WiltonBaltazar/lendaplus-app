...
const Signup = () => {
  return (
    <Suspense fallback={
      ...
      <main className="flex overflow-hidden flex-col justify-center items-center px-16 py-20 min-h-screen text-sm text-black bg-neutral-900 max-md:px-5 w-full">
